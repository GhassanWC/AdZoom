...
function materializeExport(id: string, data: Record<string, unknown>): ExportDoc {
  ...
  return {
    ...
    container: data.container as ExportDoc["container"],
    engine: data.engine as ExportDoc["engine"],
    stored: data.stored as boolean | undefined,
    outputWidth: data.outputWidth as number | undefined,
    outputHeight: data.outputHeight as number | undefined,

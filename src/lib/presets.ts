...
const settings = (over: Partial<EffectsSettings>): EffectsSettings => ({
  ...
  cursorSmoothing: 65,
  zoomSpeed: 55,
  // A Look is a whole camera personality, so it carries a zoom style too. Only
  // the Looks whose identity depends on it override this — everything else is
  // "Standard", the polished default.
  zoomPreset: "standard",
...
export const BUILTIN_PRESETS: Preset[] = [
  ...
  },
  {
    ...
    name: "Live Demo",
    category: "Product Demo",
    // Premium preset — unlocked by the $25 Pro tier and above.
    requiredPlan: "pro",
    description:

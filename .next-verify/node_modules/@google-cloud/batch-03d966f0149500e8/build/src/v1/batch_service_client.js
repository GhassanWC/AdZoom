...
class BatchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const cancelJobResponse = protoFilesRoot.lookup('.google.cloud.batch.v1.CancelJobResponse');
        const cancelJobMetadata = protoFilesRoot.lookup('.google.cloud.batch.v1.OperationMetadata');
    ...
    initialize() {
        ...
        const batchServiceStubMethods = ['createJob', 'getJob', 'deleteJob', 'cancelJob', 'listJobs', 'getTask', 'listTasks'];
